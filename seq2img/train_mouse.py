...
class CustomImageDataset(Dataset):
    """
    Dataset that returns (image, feature) pairs for single cells (mouse).

    - Loads precomputed features from 'feature_mouse.pt'
...
# Optional: load a pretrained checkpoint if available
# checkpoint = torch.load('/mlbio_scratch/wen2/imagen/ckpt_mouse_fromx0/1_34000.pt', map_location=device)
